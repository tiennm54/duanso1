                ...
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="left" style="font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                <?php
                                $url_checkout = URL::route("frontend.invoice.visaStripePay", ["token" => $model_orders->paypal_token]);
                                ?>
                                <p style="background-color: yellow"><b>Check out with VISA</b></p>
                                <p>
                                    <?php if ($model_orders->total_price > 0) { ?>
                                        <a href="{{ $url_checkout }}" target="_blank">
                                            <img align="center" alt="Buy premium key com" src="{{url('theme_frontend/image/pay-now-button.png')}}" style="height: 100px" border="0">
