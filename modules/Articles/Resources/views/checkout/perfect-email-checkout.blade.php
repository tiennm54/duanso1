                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="responsive-table">
                        ...
                        <tr>
                            <td align="left" style="font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                ...
                                <?php if ($model_orders->total_price > 0) { ?>
                                    <p style="background-color: yellow"><b>Perfect Money Instructions</b></p>
                                    <ul>
                                        <li>1. Visit website: <a href="https://perfectmoney.is/">https://perfectmoney.is/</a></li>
                                        <li>2. Please transfer your money to wallet: <b>{{ $model_orders->payment_type->payment_id }}</b> ({{$model_orders->payment_type->email}})</li>
                                        ...
                                        <li>4. Set the "Description": <span style="color: red">(You must correct this description)</span> <br>
                                            <b>Payment for Invoice: #{{ $model_orders->id }}</b>
                                        </li>
                                    </ul>
                                <?php } ?>
                            </td>
