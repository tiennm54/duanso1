    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <div class="pull-right">
                ...
                <a href="<?php echo URL::route('articles.view', ['id' => $model->id]); ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="View"><i class="fa fa-eye"></i></a>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control border-input" name="int_instock">
                                            ...
                                            <option value="0" <?php if($model->status_stock == 0){ echo "selected"; } ?>>Not In Stock</option>
                                        </select>
                                    </div>
                                </div>
